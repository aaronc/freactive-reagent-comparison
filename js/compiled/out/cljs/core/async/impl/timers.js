...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_21990 = (0);while(true){
if((i_21990 < arr.length))
{(arr[i_21990] = null);
{
var G__21991 = (i_21990 + (1));
i_21990 = G__21991;
continue;
}
} else
...
{var i_21997 = (self__.level + (1));while(true){
if((i_21997 <= (new_level + (1))))
{(update[i_21997] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_21999 = (0);while(true){
if((i_21999 <= self__.level))
{var links_22000 = (update[i_21999]).forward;if(((links_22000[i_21999]) === x__$1))
