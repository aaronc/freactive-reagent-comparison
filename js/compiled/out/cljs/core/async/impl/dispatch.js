...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_22070 = (0);while(true){
var m_22071 = cljs.core.async.impl.dispatch.tasks.pop();if((m_22071 == null))
{} else
{m_22071.call(null);
if((count_22070 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__22072 = (count_22070 + (1));
count_22070 = G__22072;
continue;
}
} else
{}
