...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__11495__auto__ = (w["requestAnimationFrame"]);if(cljs.core.truth_(or__11495__auto__))
{return or__11495__auto__;
} else
{var or__11495__auto____$1 = (w["webkitRequestAnimationFrame"]);if(cljs.core.truth_(or__11495__auto____$1))
{return or__11495__auto____$1;
} else
{var or__11495__auto____$2 = (w["mozRequestAnimationFrame"]);if(cljs.core.truth_(or__11495__auto____$2))
{return or__11495__auto____$2;
} else
{var or__11495__auto____$3 = (w["msRequestAnimationFrame"]);if(cljs.core.truth_(or__11495__auto____$3))
...
var n__12365__auto__ = a.length;var i = (0);while(true){
if((i < n__12365__auto__))
{var c_13127 = (a[i]);if(cljs.core.truth_((c_13127["cljsIsDirty"])))
{(c_13127["forceUpdate"])();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__12072__auto__,writer__12073__auto__,opt__12074__auto__){return cljs.core._write.call(null,writer__12073__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(c){var G__13130 = c;var G__13130__$1 = (((G__13130 == null))?null:(G__13130["props"]));var G__13130__$2 = (((G__13130__$1 == null))?null:(G__13130__$1["argv"]));return G__13130__$2;
});
...
reagent.impl.batching.dispose = (function dispose(c){var G__13132_13133 = (c["cljsRatom"]);var G__13132_13134__$1 = (((G__13132_13133 == null))?null:reagent.ratom.dispose_BANG_.call(null,G__13132_13133));return reagent.impl.batching.mark_rendered.call(null,c);
});
