...
{return (function() { 
var G__13149__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__11495__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__11495__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__13152 = o;(G__13152[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__13152;
}),{},x);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__13153){var vec__13155 = p__13153;var id = cljs.core.nth.call(null,vec__13155,(0),null);var class$ = cljs.core.nth.call(null,vec__13155,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_13156 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_13156 === "key")))
{(o[pname_13156] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__13159 = jsprops;(G__13159["defaultValue"] = value);
(G__13159["value"] = null);
(G__13159["onChange"] = ((function (G__13159,on_change,value){
return (function (p1__13157_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__13157_SHARP_);
});})(G__13159,on_change,value))
);
return G__13159;
}
});
...
reagent.impl.template.wrapped_should_update = (function wrapped_should_update(c,nextprops,nextstate){var or__11495__auto__ = reagent.impl.util._STAR_always_update_STAR_;if(cljs.core.truth_(or__11495__auto__))
{return or__11495__auto__;
} else
{var a1 = (c["props"]["argv"]);var a2 = (nextprops["argv"]);return cljs.core.not.call(null,reagent.impl.util.equal_args.call(null,a1,a2));
}
});
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__13161 = spec;(G__13161["componentDidUpdate"] = ((function (G__13161){
return (function (){var c = this;return reagent.impl.template.input_did_update.call(null,c);
});})(G__13161))
);
(G__13161["componentWillUnmount"] = ((function (G__13161){
return (function (){var c = this;return reagent.impl.batching.dispose.call(null,c);
});})(G__13161))
);
return G__13161;
});
reagent.impl.template.wrap_component = (function wrap_component(comp,extras,name){var input_QMARK_ = reagent.impl.template.input_component_QMARK_.call(null,comp);var input_setup = ((input_QMARK_)?reagent.impl.template.input_render_setup:null);var spec = {"displayName": (function (){var or__11495__auto__ = name;if(cljs.core.truth_(or__11495__auto__))
{return or__11495__auto__;
} else
{return "ComponentWrapper";
}
})(), "shouldComponentUpdate": ((function (input_QMARK_,input_setup){
return (function (p1__13162_SHARP_,p2__13163_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__13162_SHARP_,p2__13163_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__13165 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__13165,(0),null);var id = cljs.core.nth.call(null,vec__13165,(1),null);var class$ = cljs.core.nth.call(null,vec__13165,(2),null);var comp = ((React["DOM"])[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__11495__auto__ = id;if(cljs.core.truth_(or__11495__auto__))
{return or__11495__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__13167 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__13167,(0),null);var id_class = cljs.core.nth.call(null,vec__13167,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = {"level": level, "argv": v};var k_13168 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__13169 = (((k_13168 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_13168);if((k_SINGLEQUOTE__13169 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__13169);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__12365__auto___13170 = a.length;var i_13171 = (0);while(true){
if((i_13171 < n__12365__auto___13170))
{(a[i_13171] = reagent.impl.template.as_component.call(null,(a[i_13171]),level_SINGLEQUOTE_));
{
